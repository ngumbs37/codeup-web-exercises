...
function number() {
    ...
    if (answer) {
        ...
        var isANumber = !isNaN(userNumber);
        if (isANumber) {
            ...
            alert("The entered number plus 100 is: " + plus100 + ".");
            ...
            alert("The information entered is not a number.")
        }
    }
}
...
if (!isNaN(userInputPrice) && userInputPrice !== "") {
    alert("Using the discount of lucky number " + luckyNumber + " applied on the amount of $" +
        userInputPrice + ", the amount due is $" +
        calculateTotal(luckyNumber, userInputPrice));
} else {
